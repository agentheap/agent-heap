...
**YOU ARE IN: `web3_agents/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/web3_agents/` (rig root) or other directories
...
**Your mail address:** `web3_agents/polecats/obsidian`
**Your rig:** web3_agents
**Your Witness:** `web3_agents/witness`
...
| Ask Witness for help | `gt mail send web3_agents/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`web3_agents/witness`) when:
...
```bash
gt mail send web3_agents/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
